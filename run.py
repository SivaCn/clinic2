...
def views(filename):
    return bottle.static_file(filename, root='clinic/static/htmls')

@app.get('/<filename:re:.*\.js>')
def javascripts(filename):
    return bottle.static_file(filename, root='clinic/static/js')

@app.get('/<filename:re:.*\.snippet>')
def get_snippet(filename):
    _snippet_object = bottle.static_file(filename, root='clinic/static/snippets')
...
def get_json(filename):
    _json_object = bottle.static_file(filename, root='clinic/static/json')
...
def stylesheets(filename):
    return bottle.static_file(filename, root='clinic/static/css')

@app.get('/<filename:re:.*\.(jpg|jpeg|png|gif|ico)>')
def images(filename):
    return bottle.static_file(filename, root='clinic/static/images')
